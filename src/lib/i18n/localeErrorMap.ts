        ...
        const getTranslationKey = () => {
            switch (issue.code) {
                ...
                case ZodIssueCode.too_big:
                    ...
                    const sizeIssue =
                        issue.code === ZodIssueCode.too_small ? "too_small" : "too_big";
                    const sizeParam = issue.code === ZodIssueCode.too_small ? "min" : "max";
                    const sizeValue =
                        issue.code === ZodIssueCode.too_small ? issue.minimum : issue.maximum;
