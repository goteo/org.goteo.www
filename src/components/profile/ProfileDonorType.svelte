...
<div class="mx-auto mt-10 flex w-full gap-6 px-10">
    ...
    <!-- Next Level Card -->
    <div class="bg-white border-grey flex max-h-64 grow flex-col gap-6 rounded-3xl border p-6">
        ...
        <div class="flex w-full items-center justify-between gap-2">
            ...
            <!-- Progress Bar -->
            <div
                class="bg-white border-grey flex h-4 w-full grow rounded-lg border p-[2px] shadow-lg"
            >
                <div
