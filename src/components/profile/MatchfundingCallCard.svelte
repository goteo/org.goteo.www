...
<div
    class="relative box-border flex w-full flex-col items-start justify-center gap-2 overflow-hidden rounded-8 px-0 py-8 md:py-12 lg:py-16"
>
    <!-- Background Image -->
    {#if call.imageUrl}
        <div aria-hidden="true" class="pointer-events-none absolute inset-0 rounded-8">
            <div class="absolute inset-0 overflow-hidden rounded-8">
                <img
                    alt=""
                    src={call.imageUrl}
    ...
    >
        ...
        {#if call.logo}
            <div
                class="border-grey flex size-48 shrink-0 flex-col items-center justify-center gap-2 rounded-8 border border-solid bg-white p-8 md:size-56 lg:size-64"
            >
