...
{#if isEmpty}
    <!-- Empty State -->
    <div
        class="bg-white border-grey relative flex min-h-[384px] flex-col items-center justify-between overflow-clip rounded-[32px] border p-6"
    >
...
{:else}
    <!-- Filled State -->
    <div
        class="bg-white border-grey relative flex min-h-[384px] flex-col justify-between overflow-clip rounded-[32px] border p-6"
    >
