<media-captions
    class="media-controls:bottom-[85px] media-preview:opacity-0 .captions absolute inset-0 bottom-2 z-10 break-words opacity-0 transition-[opacity,bottom] duration-300 select-none data-[visible]:opacity-100"
>
</media-captions>
