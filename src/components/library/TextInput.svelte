...
<div class={twMerge("relative", disabled && "opacity-40")}>
    ...
    <input
        ...
        {placeholder}
        class={twMerge(
            "peer bg-background border-secondary focus:ring-tertiary w-full rounded-md border p-4 text-base text-gray-700 placeholder-gray-400 focus:ring-1 focus:outline-none",
