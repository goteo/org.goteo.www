...
<div class="flex flex-col gap-10">
    ...
    <Carousel gap={16} showDots={true} {itemsPerGroup}>
        ...
        {#each projectsUpdates as update}
            <div
                class="bg-background flex w-full flex-col justify-between gap-6 rounded-4xl p-6 font-bold"
            >
    ...
    <Modal
        ...
        class="bg-background fixed top-1/2 left-1/2 w-full max-w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-3xl p-6 shadow-lg backdrop:bg-[#878282B2] backdrop:backdrop-blur-[5px]"
    >
        {#if selected}
