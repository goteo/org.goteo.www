...
<div class="flex flex-col gap-10">
    ...
    <Modal
        ...
        class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[800px] w-full p-6 rounded-3xl bg-white shadow-lg backdrop:bg-[#878282B2] backdrop:backdrop-blur-[5px]"
    >
        {#if selectedProject}
