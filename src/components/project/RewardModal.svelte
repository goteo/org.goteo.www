...
<Modal
    bind:open
    closeBtnClass="top-7 end-12 bg-transparent text-secondary hover:bg-transparent hover:text-secondary hover:scale-110 transition-transform duration-200 transform focus:ring-0 shadow-none dark:text-secondary dark:hover:text-secondary dark:hover:bg-transparent"
...
>
    <div
        class="flex max-h-[85vh] flex-col gap-6 overflow-y-auto rounded-3xl bg-white p-8 shadow-lg"
