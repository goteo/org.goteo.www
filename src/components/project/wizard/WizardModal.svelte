<script lang="ts">
    ...
    let selectedBudgetType = $state(budgetItem?.type ?? "");
    let selectedBudgetDeadline = $state(budgetItem?.deadline ?? "");
    ...
    $effect(() => {
        if (!collab && !budgetItem && reward) selectedStep = "rewards";
        else if (!reward && !budgetItem && collab) selectedStep = "collabs";
        else if (!reward && !collab && budgetItem) selectedStep = "budget";
    });
</script>
    ...
    <div class="flex flex-col gap-4">
        {#if reward}
            ...
            <input
                ...
                class={INPUTS_CLASSES}
                value={reward.money.amount && reward.money.currency
        ...
        {:else if budgetItem}
            ...
            >
                ...
                <option
                    ...
                    selected={budgetItem.type && budgetItem.type === "infrastructure"}
            ...
            <div class="flex">
                ...
                >
                    ...
                    >
                    <option
                        selected={selectedBudgetDeadline && selectedBudgetDeadline === "minimum"
                            ? true
                            : false}
                        value="minimum"
                    ...
                    >
                    <option
                        selected={selectedBudgetDeadline && selectedBudgetDeadline === "optimum"
                            ? true
                            : false}
                        value="optimum"
