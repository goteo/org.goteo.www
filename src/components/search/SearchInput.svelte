...
>
    ...
    {#if searchQuery}
        <button
            onclick={clearSearch}
            class="text-secondary ml-2 flex h-8 w-8 shrink-0 items-center justify-center rounded-full transition-colors hover:bg-[#e6e6e6]"
    ...
    <!-- Floating label -->
    <div class="-top-1.125 pointer-events-none absolute left-3 bg-white px-1">
