...
export const apiGatewayCheckoutsGetCollection = <ThrowOnError extends boolean = false>(options?: Options<ApiGatewayCheckoutsGetCollectionData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiGatewayCheckoutsGetCollectionResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const apiUsersIdOrHandleGet = <ThrowOnError extends boolean = false>(options: Options<ApiUsersIdOrHandleGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiUsersIdOrHandleGetResponses, ApiUsersIdOrHandleGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
