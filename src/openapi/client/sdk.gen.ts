 ...
 */
export const apiCategoriesIdOrSlugGet = <ThrowOnError extends boolean = false>(options: Options<ApiCategoriesIdOrSlugGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiCategoriesIdOrSlugGetResponses, ApiCategoriesIdOrSlugGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const apiGatewaysIdGet = <ThrowOnError extends boolean = false>(options: Options<ApiGatewaysIdGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiGatewaysIdGetResponses, ApiGatewaysIdGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const apiGatewayChargestotalsGetCollection = <ThrowOnError extends boolean = false>(options?: Options<ApiGatewayChargestotalsGetCollectionData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiGatewayChargestotalsGetCollectionResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
