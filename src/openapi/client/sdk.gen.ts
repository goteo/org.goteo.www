...
/**
 * Retrieves a AccountingBalance resource.
 * Retrieves one AccountingBalance resource.
 */
export const apiAccountingsIdbalanceGet = <ThrowOnError extends boolean = false>(options: Options<ApiAccountingsIdbalanceGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiAccountingsIdbalanceGetResponses, ApiAccountingsIdbalanceGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiProjectRewardClaimsIdPatch = <ThrowOnError extends boolean = false>(options: Options<ApiProjectRewardClaimsIdPatchData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ApiProjectRewardClaimsIdPatchResponses, ApiProjectRewardClaimsIdPatchErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
