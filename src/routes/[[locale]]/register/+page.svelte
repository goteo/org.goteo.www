        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center gap-4">
                ...
                <Button variant="secondary" href={`/login`}
                    >{$_("register.page.loginButton")}</Button
                >
            </div>
            <form method="POST" class="max-w-md space-y-4" use:enhance>
                        ...
                        <div class="flex items-center space-x-3 space-y-0">
                            <Form.Control let:attrs>
                                ...
                                <Form.Label class="font-normal"
                                    >{$_("register.form.userType.individual")}</Form.Label
                                >
                            </Form.Control>
                        </div>
                        <div class="flex items-center space-x-3 space-y-0">
                            <Form.Control let:attrs>
                                ...
                                <Form.Label class="font-normal"
                                    >{$_("register.form.userType.organization")}</Form.Label
                                >
                            </Form.Control>
                        </div>
                ...
                <Form.Field {form} name="terms" class="flex items-center space-x-2">
                    <Form.Control let:attrs>
                        ...
                        <Form.Label class="font-normal"
                            >{$_("register.form.termsCheckbox")}</Form.Label
                        >
